...
export declare const extModes: string[];
export type ExtMode = (typeof extModes)[number];
export declare const resizeType: string[];
...
export type CompressionOption = JpegCompressionOption & SVGCompressionOption & GifCompressionOption & GenericCompressionOptions;
/**
...
export type OutputData = OutputInfo | {
    src: string;
    dist: string;
    originalSize: number;
    size: number;
