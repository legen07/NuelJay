import { type Config as SvgoConfig, type PluginConfig as SvgoPluginConfig } from "svgo";
import { type Compressor, type InputFormats } from "./constants.js";
import { CompressImagePaths, type CompressionOption, type CompressionOptionsMap } from "./types.js";
/**
 ...
 * format.
 */
export declare function getCompressionOptions(imageFormat: string, options: CompressionOptionsMap): Partial<CompressionOption> | undefined;
/**
 * Type guard for image formats
 *
 * @param ext the image format to check
 */
export declare function asInputFormats(ext: string | undefined): ext is InputFormats;
/**
 ...
 */
export declare function getImageFormatsInFolder(folderPath: string): InputFormats[];
/**
 ...
 */
export declare function logMessage(message: string, verbose?: boolean): void;
/**
 ...
 */
export declare function getOutputExtension(compressor: Compressor | undefined, originalExt: InputFormats): string;
/**
 ...
 */
export declare function getDefaultCompressor(compressor: string | undefined, format: string): string;
/**
 ...
 */
export declare function getQuality(quality: number, format: string): number | undefined;
/**
 ...
 */
export declare function getJpgCompressionOptions(progressive: boolean | undefined): boolean;
/**
 ...
 */
export declare function getSvgoPluginOptions(optionsProvided: string[]): SvgoPluginConfig[];
/**
 ...
 */
export declare function getSvgoOptions(options: SvgoPluginConfig[] | undefined): SvgoConfig;
/**
 ...
 */
export declare function defaultCompressionOptions(imageFormats?: InputFormats[]): CompressionOptionsMap;
/**
 ...
 */
export declare function getFileName(extMode: string | undefined, paths: CompressImagePaths, compressor: Compressor): string;
/**
 ...
 */
export declare function generateDefaultConfigFile(filename: string, argv: Record<string, string>): void;
